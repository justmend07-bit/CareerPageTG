    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        {/* <div className="mt-20 relative">
          <div className="bg-white/60 backdrop-blur-md rounded-3xl shadow-2xl p-8 max-w-4xl mx-auto">
            <div className="aspect-video bg-gradient-to-br from-orange-200 to-amber-200 rounded-2xl flex items-center justify-center">
              <div className="text-center">
                <Heart className="w-16 h-16 text-orange-600 mx-auto mb-4" />
                <p className="text-gray-700 font-medium">A peaceful journey of companionship</p>
              </div>
            </div>
          </div>
        </div> */}
